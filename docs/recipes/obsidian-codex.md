...
![obsidian-terminal-plugin-search](../images/obsidian-terminal-plugin-search.png)

安装完成后需要进行配置，否则无法正常使用：

![obsidian-terminal-plugin-settings](../images/obsidian-terminal-plugin-settings.png)

在配置中选择想要的终端输入方式：

![obsidian-terminal-profiles-config](../images/obsidian-terminal-profiles-config.png)
...
![obsidian-command-palette-integrated-terminal](../images/obsidian-command-palette-integrated-terminal.png)

此时页面下方会出现一个命令行界面：

![obsidian-embedded-terminal-open](../images/obsidian-embedded-terminal-open.png)
...
![obsidian-codex-terminal-start](../images/obsidian-codex-terminal-start.png)
...
![obsidian-codex-image-generation-prompt](../images/obsidian-codex-image-generation-prompt.png)

成功出图：

![obsidian-codex-image-generation-result-url](../images/obsidian-codex-image-generation-result-url.png)

生成效果如图所示：

![obsidian-codex-llm-wiki-concept-image](../images/obsidian-codex-llm-wiki-concept-image.png)
...
![obsidian-codex-image-upload-tools-search](../images/obsidian-codex-image-upload-tools-search.png)

然后它会自己自动完成这个任务，最后返回给我们一个对应图床的链接。

![obsidian-codex-image-upload-link-result](../images/obsidian-codex-image-upload-link-result.png)
