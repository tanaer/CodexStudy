...
![feishu-cli-install-result](../images/feishu-cli-install-result.png)
...
![feishu-cli-create-app-prompt](../images/feishu-cli-create-app-prompt.png)

打开链接，创建应用：

![feishu-cli-create-custom-app-modal](../images/feishu-cli-create-custom-app-modal.png)

按照它的指引创建应用之后，把 App ID 和 App Secret 发给它，Codex 会自动完成飞书应用配置和权限申请。

![feishu-cli-doc-export-tools-result](../images/feishu-cli-doc-export-tools-result.png)

> 过程中会涉及**手动授权**操作。Codex 会提供跳转链接，点击在浏览器里放行对应权限即可，这样它才能读取和操作你的飞书数据。

![feishu-cli-oauth-login-link](../images/feishu-cli-oauth-login-link.png)
...
![feishu-cli-document-list-result](../images/feishu-cli-document-list-result.png)

Codex 还会贴心地告诉你第一次应该怎么用，连提示词都帮你准备好了。

![feishu-cli-command-examples](../images/feishu-cli-command-examples.png)
...
![feishu-cli-image-generation-prompt](../images/feishu-cli-image-generation-prompt.png)
...
![feishu-cli-generated-image-preview](../images/feishu-cli-generated-image-preview.png)
