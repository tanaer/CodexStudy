...
![Codex 桌面 App 主界面](../images/codex-app-main-chat-home.png)
...
![Project 工作区界面](../images/codex-app-project-workspace-selection.png)
...
![设置入口](../images/codex-app-profile-menu-settings-billing.png)

![设置面板详情](../images/codex-app-settings-panel-detail.png)
