...
![agents-md-editor-rule-example](../images/agents-md-editor-rule-example.png)
...
![codex-app-personalization-settings](../images/codex-app-personalization-settings.png)
